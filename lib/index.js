...
var createComponent = function () { return __awaiter(void 0, void 0, void 0, function () {
    var templateSrc, componentString, indexString, componentTemplate, indexTemplate, data, index, dssss;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                templateSrc = getTemplateSrc();
                console.log(templateSrc);
                return [4 /*yield*/, readFilePromise("".concat(templateSrc === null || templateSrc === void 0 ? void 0 : templateSrc.path, "/Template.ts"))];
            case 1:
                componentString = _a.sent();
                return [4 /*yield*/, readFilePromise("".concat(templateSrc === null || templateSrc === void 0 ? void 0 : templateSrc.path, "/index.ts"))];
            case 2:
                indexString = _a.sent();
                componentTemplate = handlebars_1.default.compile(componentString);
                indexTemplate = handlebars_1.default.compile(indexString);
                console.log(componentTemplate);
                data = {
                    name: componentName,
                };
                index = indexTemplate(data).replace(/`/g, "");
                dssss = componentTemplate(data).replace(/`/g, "");
                console.log(index);
